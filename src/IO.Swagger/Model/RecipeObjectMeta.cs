...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RecipeObjectMeta :  IEquatable<RecipeObjectMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipeObjectMeta" /> class.
        /// </summary>
        /// <param name="url">URL to the recipe. You must link back to the recipe when displaying it..</param>
        /// <param name="images">images.</param>
        /// <param name="source">The source of the recipe. You must attribute this source when displaying this recipe..</param>
        /// <param name="cuisine">This recipe&#x27;s cuisine.</param>
        /// <param name="created">The date when this recipe was created.</param>
        /// <param name="modified">The date when this recipe was most recently modified.</param>
        /// <param name="nutrientsNotice">Additional information about this recipe&#x27;s nutrients.</param>
        public RecipeObjectMeta(string url = default(string), RecipeObjectMetaImages images = default(RecipeObjectMetaImages), string source = default(string), string cuisine = default(string), string created = default(string), string modified = default(string), string nutrientsNotice = default(string))
        {
            this.Url = url;
            this.Images = images;
            this.Source = source;
        ...
        [DataMember(Name="nutrients_notice", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as RecipeObjectMeta);
        }

        /// <summary>
        /// Returns true if RecipeObjectMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of RecipeObjectMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipeObjectMeta input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Cuisine == input.Cuisine ||
                    (this.Cuisine != null &&
                    this.Cuisine.Equals(input.Cuisine))
                ) && 
                (
                ...
                (
                    this.NutrientsNotice == input.NutrientsNotice ||
                    (this.NutrientsNotice != null &&
                    this.NutrientsNotice.Equals(input.NutrientsNotice))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Cuisine != null)
                    hashCode = hashCode * 59 + this.Cuisine.GetHashCode();
                if (this.Created != null)
                    hashCode = hashCode * 59 + this.Created.GetHashCode();
                if (this.Modified != null)
                    hashCode = hashCode * 59 + this.Modified.GetHashCode();
                if (this.NutrientsNotice != null)
                    hashCode = hashCode * 59 + this.NutrientsNotice.GetHashCode();
                return hashCode;
            }
        }
