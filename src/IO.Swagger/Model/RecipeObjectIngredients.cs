...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RecipeObjectIngredients :  IEquatable<RecipeObjectIngredients>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipeObjectIngredients" /> class.
        /// </summary>
        /// <param name="quantity">The quantity of this ingredient.</param>
        /// <param name="description">A description of this ingredient.</param>
        public RecipeObjectIngredients(string quantity = default(string), string description = default(string))
        {
        ...
        {
            return this.Equals(input as RecipeObjectIngredients);
        }

        /// <summary>
        /// Returns true if RecipeObjectIngredients instances are equal
        /// </summary>
        /// <param name="input">Instance of RecipeObjectIngredients to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipeObjectIngredients input)
        {
            if (input == null)
                return false;
