...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IngredientObjectComponents :  IEquatable<IngredientObjectComponents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngredientObjectComponents" /> class.
        /// </summary>
        ...
        public IngredientObjectComponents(string name = default(string), decimal? pctWeight = default(decimal?), decimal? gramWeight = default(decimal?), bool? isRefuse = default(bool?), int? dataPoints = default(int?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as IngredientObjectComponents);
        }

        /// <summary>
        /// Returns true if IngredientObjectComponents instances are equal
        /// </summary>
        /// <param name="input">Instance of IngredientObjectComponents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngredientObjectComponents input)
        {
            if (input == null)
                return false;
