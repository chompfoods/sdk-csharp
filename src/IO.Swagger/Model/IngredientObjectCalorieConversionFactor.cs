...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IngredientObjectCalorieConversionFactor :  IEquatable<IngredientObjectCalorieConversionFactor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngredientObjectCalorieConversionFactor" /> class.
        /// </summary>
        ...
        public IngredientObjectCalorieConversionFactor(decimal? proteinValue = default(decimal?), decimal? fatValue = default(decimal?), decimal? carbohydrateValue = default(decimal?))
        {
        ...
        {
            return this.Equals(input as IngredientObjectCalorieConversionFactor);
        }

        /// <summary>
        /// Returns true if IngredientObjectCalorieConversionFactor instances are equal
        /// </summary>
        /// <param name="input">Instance of IngredientObjectCalorieConversionFactor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngredientObjectCalorieConversionFactor input)
        {
            if (input == null)
                return false;
