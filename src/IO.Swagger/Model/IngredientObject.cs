...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IngredientObject :  IEquatable<IngredientObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngredientObject" /> class.
        /// </summary>
        /// <param name="items">An array containing an object for each individual item returned by your API call..</param>
        public IngredientObject(List<IngredientObjectItems> items = default(List<IngredientObjectItems>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as IngredientObject);
        }

        /// <summary>
        /// Returns true if IngredientObject instances are equal
        /// </summary>
        /// <param name="input">Instance of IngredientObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngredientObject input)
        {
            if (input == null)
                return false;
